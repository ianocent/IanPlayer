...
| Asset | Link                                                                                                          |
| :--- |:--------------------------------------------------------------------------------------------------------------|
| **APK (Latest)** | [IanPlayer-v.2.5.5.apk](https://github.com/ianocent/ianplayer/releases/download/v2.5.5/IanPlayer-v.2.5.5.apk) |
| **Release Notes** | [v2.5.5](https://github.com/ianocent/IanPlayer/releases/tag/v2.5.5)                                           |
