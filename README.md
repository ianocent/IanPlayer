...
| Asset | Link                                                                                                          |
| :--- |:--------------------------------------------------------------------------------------------------------------|
| **APK (Latest)** | [IanPlayer-v.2.0.0.apk](https://github.com/ianocent/ianplayer/releases/download/v2.0.0/IanPlayer-v.2.0.0.apk) |
| **Release Notes** | [v2.0.0](https://github.com/ianocent/IanPlayer/releases/tag/v2.0.0)                                           |
